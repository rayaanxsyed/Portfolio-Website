        ...
        >
            ...
            <div className="w-full h-full overflow-hidden">
              <img
                ...
                style={{
                  ...
                  transform: "scale(0.99) translate(0%, 1%)",
                }}
              />
            </div>
          </div>
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://www.linkedin.com/in/rayaan-syed/", "_blank")}
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://github.com/rayaanxsyed", "_blank")}
            >
