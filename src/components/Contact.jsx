    ...
    emailjs
      .send(
        ...
        'template_tn53hil',
        {
          ...
          to_email: "rayaan.syed@mail.utoronto.ca",
    ...
    <div className={`xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden no-select`}>
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <p className={styles.sectionSubText}>Let's talk more!</p>
          <a
            href="tel:+9054426746"
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Hey Rayaan, I'd like to chat about some opportunities regarding your work."
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium transition-all duration-300 focus:ring-2 focus:ring-purple-500'
            />
          </label>
        ...
        >
          Copyright &copy; {new Date().getFullYear()} Rayaan Syed's Portfolio
          <br />
          Designed and Developed by
          <a
            href="https://www.linkedin.com/in/rayaan-syed/"
            target="_blank"
